...
/// Flags that describe how a buffer can be used.
...
/// Flags that describe how a texture can be used.
...
/// Flags that describe which shader stages a resource is visible to.
...
/// Flags that describe which color channels are written.
...
/// Flags that describe the mapping mode for a buffer.
